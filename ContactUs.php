...
<!-- title picture -->
      <div style="background: linear-gradient(#f3ebd4,#ffdc77); margin:0; border:0; height:14vh; display:flex">
        <h1 class="container" style="font-family: 'Comic Sans MS', cursive, sans-serif; color:#cc2b2b; font-weight:bold; align-self:flex-end">Wei's Kitchen</h1>
      </div>
...
<!-- menu bar -->
      ...
      <div class="container" style="background-color: white"><h4 class="fontSans">647-646-9055<br>E-mail: weima@gmail.com</h4></div>
